...
<body>
                                    ...
                                    <div class="row justify-content-center mt-1">
                                        ...
                                        <div class="col-12 col-sm-12 col-lg-9">
                                            <div class="accordion faq-accordian" id="faqAccordion">
                                                ...
                                                <div class="card-header" id="headingFour">
                                                    <h5 class="mb-0 collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseFour">Apakah Harga di website dengan di toko fisik sama?<span class="lni-chevron-up"></span></h6>
                                                </div>
                                                <div class="collapse" id="collapseFour"
                                                    aria-labelledby="headingFour" data-parent="#faqAccordion">
                                                    <div class="card-body">
                                                        <p>Ya, website laundry Cuciin juga berfungsi sebagai penyedia informasi harga dari layanan kami.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card border-0 wow fadeInUp" data-wow-delay="0.4s"
                                                ...
                                                <div class="card-header" id="headingFive">
                                                    <h5 class="mb-0 collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseFive">Kapan jadwal penjemputan dan pengantaran Laundry Cuciin?<span class="lni-chevron-up"></span></h6>
                                                </div>
                                                <div class="collapse" id="collapseFive"
                                                    aria-labelledby="headingFive" data-parent="#faqAccordion">
                                                    <div class="card-body">
                                                        <p>Untuk kenyamanan pelanggan, pelanggan dapat memilih 3 waktu pengantaran dan penjemputan, yaitu :<br> 
                                                            Pagi Hari : 09.00 - 11.30<br>
                                                            Siang Hari : 12.30 - 15.00<br>
                                                            Sore Hari : 16.00 - 18.00<br></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card border-0 wow fadeInUp" data-wow-delay="0.4s"
                                                ...
                                                <div class="card-header" id="headingSix">
                                                    <h5 class="mb-0 collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseSix">Kapan waktu toko fisik buka?<span class="lni-chevron-up"></span></h6>
                                                </div>
                                                <div class="collapse" id="collapseSix"
                                                    aria-labelledby="headingSix" data-parent="#faqAccordion">
                                                    <div class="card-body">
                                                        <p>Berikut adalah jadwal operasional toko fisik :<br> 
                                                            Senin - Jum'at : 08.30 - 20.00<br>
                                                            Sabtu - Minggu : 08.30 - 16.00<br></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card border-0 wow fadeInUp" data-wow-delay="0.4s"
                                                ...
                                                <div class="card-header" id="headingSeven">
                                                    <h5 class="mb-0 collapsed" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseSeven">Berapa jarak maksimum tercover oleh layanan antar-jemput?<span class="lni-chevron-up"></span></h6>
                                                </div>
                                                <div class="collapse" id="collapseSeven"
                                                    aria-labelledby="headingSeven" data-parent="#faqAccordion">
                                                    <div class="card-body">
                                                        <p>Jarak Maksimum yang tercover oleh Layanan antar-jemput dari kami adalah 6 km,<br>
                                                        jika ada pemesanan diluar dari radius 6 km, mohon maaf pesanan akan ditolak oleh admin.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="support-button text-center d-flex align-items-center justify-content-center mt-4 wow fadeInUp"
                                                ...
                                                <p class="mb-0 px-2">Hubungi kami di 0821-9494-1111 atau gnardi1111@gmail.com</p>
    ...
    <!-- Bot Navigation-->
    <nav class="navbar sticky-bottom bg-light static-bot">
        <div class="container">
            <img src="icon cuciin.png" alt="">
