...
<body>
    ...
    <nav class="navbar bg-light static-top">
      <div class="container">
          ...
          <a class="btn btn-primary btn-lg" href="register.php">Daftar</a>
      </div>
  </nav>
              ...
              <div class="card bg-white text-light" style="border-radius: 2rem;">
                <div class="card-body p-5 text-center">
                  ...
                  <form action="" method="POST" class="login-email">
                    ...
                    <p class="text-light-50 mb-5 ">Masukkan Username dan Password Anda!</p>
      
                    <div class=" form-light mb-4 h-6">
                        <label class="form-label h5" for="username">Username</label>
                        <input type="text" placeholder="username" name="username" class="form-control form-control-lg" value="<?php echo $_POST['username']; ?>" required>
                    </div>
      
                    <div class=" form-light mb-4">
                        <label class="form-label h5" for="username">Password</label>
                  ...
                  <div>
                    <p class="mb-0">Belum Memiliki Akun? <a href="register.php" class="text-light-50 fw-bold text-decoration-none">Klik Disini.</a>
                    </p>
                  </div>
