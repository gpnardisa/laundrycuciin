...
$result = mysqli_query($conn, "SELECT * FROM pesanan ORDER BY date DESC");
?>
                    ...
                    <div class="card bg-white text-light" style="border-radius: 2rem;">
                        <div class="card-body p-5 text-center">
                                ...
                                <form action="" method="post">
                                    <h2 class="fw-bold mb-2 text-center ">Daftar Pesanan Masuk</h2>
                                    <p class="text-light-50 mb-3 text-center">Pesanan yang masuk akan tampil di sini!
                                    </p>

                                    <div class="text-end">
                                    <a href="riwayatadmin.php">Riwayat Pesanan >      </a><br /><br />
                                    </div>
